 ...
 * 
 * Handles REST API endpoints for Sweet Portofolio.
 */
class PortofolioController
{
  ...
  public function register_routes()
  {
    register_rest_route('sweet-portofolio/v1', '/generate-portfolio-page', array(
      'methods' => 'POST',
      'callback' => array($this, 'generate_portfolio_page'),
    ...
    register_rest_route('sweet-portofolio/v1', '/generate-preview-page', array(
      'methods' => 'POST',
      'callback' => array($this, 'generate_preview_page'),
      'permission_callback' => function () {
        return current_user_can('manage_options');
      },
      'args' => array(
   ...
   */
  public function generate_portfolio_page($request)
  {
   ...
   */
  public function generate_preview_page($request)
  {
    // Log the request for debugging
